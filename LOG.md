...
- Download lists from [InterPro](https://www.ebi.ac.uk/interpro/) ([FTP
  site](https://ftp.ebi.ac.uk/pub/databases/interpro/))
  - type list
  - short name list
...
- API manual: [Interpro 7
  API](https://github.com/ProteinsWebTeam/interpro7-api/tree/master)
...
- Pfam
  - [PF00864](https://www.ebi.ac.uk/interpro/entry/pfam/PF00864/): ATP
    P2X receptor
- InterPro
  - [IPR027309](https://www.ebi.ac.uk/interpro/entry/InterPro/IPR027309/):
