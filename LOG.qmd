...
- Copy files from anticonet_r220 repository (https://github.com/0mae/anticonet_r220/tree/main)
...
- `proteins_raw_gtdbtax_cog_synteny.tsv.gz`
  ...
  - COG is assigned.
- `seqs_split`
  - 501 chunks of amino acid sequences from HQ GTDB representative genomes
